...
try:
    ...
    behavioral_cols = ['monthly_income', 'social_media_hours', 'tech_savvy_score', 
                      'brand_loyalty_score', 'impulse_buying_score', 'return_frequency','need_touch_feel_score','product_availability_online']
